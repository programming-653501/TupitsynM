...
{
	ShowMessage("Всего выполнено упражнений: " + IntToStr(CurrentUser->GetExercisesDone()) + ".\nВсего сделано ошибок: " + IntToStr(CurrentUser->GetMistakes()) + ".\nВсего затрачено времени: " + IntToStr(CurrentUser->GetTime() / 3600) + ":" + IntToStr((CurrentUser->GetTime() % 3600) / 60) + ":" + IntToStr((CurrentUser->GetTime() % 3600) % 60) + ".");
}
//---------------------------------------------------------------------------
